package flare.apps
{
    ...
    public class JobVoyager extends App
    {
        ...
        private var _url:String = "http://ujima-project.org/Media/jobs.txt";
        private var _cols:Array = [1850,1860,1870,1880,1900,1910,1920,1930,
                                   1940,1950,1960,1970,1980,1990,2000];
        private var _titleText:String =
            "Usaid given to african nations over years " + 
            "(source: <a href='http://usspending.gov'>Usspending.gov</a>)";
        ...
        protected override function init(e:Event=null):void
        {
            ...
            _bar.loadURL(ldr, function():void {
                ...
                var data:Data = Data.fromArray(dr);                                
                visualize(data);                
                _bar = null;
            });
          }
